<div class="sb2-13">
    <ul class="collapsible" data-collapsible="accordion">
        ...
        <li><a href="javascript:void(0)" class="collapsible-header"><i class="fa fa-book" aria-hidden="true"></i>Masterdata</a>
            <div class="collapsible-body left-sub-menu">
                <ul>
                    <li><a href="{{route('clases.index')}}">Students Class</a></li>
                    <li><a href="{{route('groups.index')}}">Students Group</a></li>               
                    <li><a href="{{route('shifts.index')}}">Students Shift</a></li>
                    <li><a href="admin-all-courses.html">Students Year</a></li>
                    <li><a href="{{route('subjects.index')}}">Subject</a></li>
                    <li><a href="{{route('assign_subjects.index')}}">Assign Subject</a></li>
                    <li><a href="admin-add-courses.html">Exam Type</a></li>
                    <li><a href="admin-trash-courses.html">Designation</a></li>
                    <li><a href="admin-trash-courses.html">Fee Category</a></li>
                </ul>
            </div>
        </li>
