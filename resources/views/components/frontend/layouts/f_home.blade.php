...
<body>
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="index-2.html"><img src={{asset('ui/frontend')}}/"images/logo.png" alt="" />
                        </a>
                    </div>
                </div>
                    ...
                    <div class="ed-mm-menu">
                        ...
                        <div class="ed-mm-inn">
                            ...
                            <ul>
                                ...
                                <li><a href="{{ route('login') }}" data-toggle="modal" data-target="#modal2">Sign In</a></li>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="ed-com-t1-right">
                            ...
                            <ul>
                                ...
                                @else
                                <li><a href="{{ url('/login') }}" data-toggle="modal" data-target="#modal1">Sign In</a>
                                </li>
                                @if (Route::has('register'))
                                <li><a href="{{ route('register') }}" data-toggle="modal" data-target="#modal2">Sign Up</a>
                                                ...
                                                <div class="mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay menu-about" href="admission.html">
                                                            <img src="{{asset('ui/frontend')}}/images/h-about.jpg" alt="">
                                                            <span>Academics</span>
                                                        </a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="about.html">
                                                            <img src="{{asset('ui/frontend')}}/images/h-about1.jpg" alt="">
                                                            <span>Academics</span>
                                                        </a>
                                                    </div>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="admission.html">
                                                            <img src="{{asset('ui/frontend')}}/images/h-adm1.jpg" alt="">
                                                            <span>Admission</span>
                                                        </a>
                                                    </div>
                                                    <p>Donec lacus libero, rutrum ac sollicitudin sed, mattis non eros. Vestibulum congue nec eros quis lacinia. Mauris non tincidunt lectus. Nulla mollis, orci vitae accumsan rhoncus.</p>
                                                ...
                                                <div class="mm2-com mm1-com mm1-s1">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="awards.html">
                                                            <img src="{{asset('ui/frontend')}}/images/h-cam1.jpg" alt="">
                                                ...
                                                <div class="mm2-com mm1-com mm1-s4">
                                                    <div class="ed-course-in">
                                                        <a class="course-overlay" href="seminar.html">
                                                            <img src="{{asset('ui/frontend')}}/images/h-res1.jpg" alt="">
        ...
        <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="item slider1 active">
                    <img src="{{asset('ui/frontend')}}/images/slider/1.jpg" alt="">
                ...
                <div class="item">
                    <img src="{{asset('ui/frontend')}}/images/slider/2.jpg" alt="">
                    <div class="carousel-caption slider-con">
                ...
                <div class="item">
                    <img src="{{asset('ui/frontend')}}/images/slider/3.jpg" alt="">
                    <div class="carousel-caption slider-con">
        ...
        <div class="container">
            <div class="row">
                <div class="wed-hom-ser">
                    <ul>
                        <li>
                            <a href="awards.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('ui/frontend')}}/images/icon/h-ic1.png" alt=""> Academy</a>
                        </li>
                        <li>
                            <a href="admission.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('ui/frontend')}}/images/icon/h-ic2.png" alt=""> Admission</a>
                        </li>
                        <li>
                            <a href="all-courses.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('ui/frontend')}}/images/icon/h-ic4.png" alt=""> Courses</a>
                        </li>
                        <li>
                            <a href="seminar.html" class="waves-effect waves-light btn-large wed-pop-ser-btn"><img src="{{asset('ui/frontend')}}/images/icon/h-ic3.png" alt=""> Seminar</a>
                        </li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="dashboard.html">
                                <img src="{{asset('ui/frontend')}}/images/h-cam.jpg" alt="">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="research.html">
                                <img src="{{asset('ui/frontend')}}/images/h-res.jpg" alt="">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12">
                        <div class="ed-course-in">
                            <a class="course-overlay" href="db-time-line.html">
                                <img src="{{asset('ui/frontend')}}/images/h-adm.jpg" alt="">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div>
                        ...
                        <div class="home-top-cour">
                            ...
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-1.jpg" alt=""> </div>
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-2.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-3.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-4.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                ...
                <div class="col-md-6">
                    <div>
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-5.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-6.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                                    <h3>Agriculture Courses</h3>
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-7.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                                    <h3>Marine Engineering</h3>
                        ...
                        <div class="home-top-cour">
                            <!--POPULAR COURSES IMAGE-->
                            <div class="col-md-3"> <img src="{{asset('ui/frontend')}}/images/course/sm-8.jpg" alt=""> </div>
                            <!--POPULAR COURSES: CONTENT-->
                            <div class="col-md-9 home-top-cour-desc">
                                <a href="course-details.html">
                                    <h3>Building, Construction Management</h3>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <div class="ho-event ho-event-mob-bot-sp">
                        <ul>
                            <li>
                                <div class="ho-ev-img"><img src="{{asset('ui/frontend')}}/images/event/1.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img src="{{asset('ui/frontend')}}/images/event/2.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img src="{{asset('ui/frontend')}}/images/event/3.jpg" alt="">
                                </div>
                                <div class="ho-ev-link">
                                    <a href="#">
                            ...
                            <li>
                                <div class="ho-ev-img"><img src="{{asset('ui/frontend')}}/images/event/4.jpg" alt=""></div>
                                <div class="ho-ev-link">
                                    <a href="#">
                                        <h4>Then came the night of the first falling star.</h4>
                                    </a>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="bot-gal h-gal ho-event-mob-bot-sp">
                        <h4>Photo Gallery</h4>
                        <ul>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/8.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/9.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/10.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/11.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/1.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/2.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/3.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/4.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/5.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/6.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/7.jpg" alt="">
                            </li>
                            <li><img class="materialboxed" data-caption="Education master image captions" src="{{asset('ui/frontend')}}/images/ami/8.jpg" alt="">
                            </li>
                        </ul>
        ...
        <div id="modal1" class="modal fade" role="dialog">
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    <a href="#" class="pop-close" data-dismiss="modal"><img src="{{asset('ui/frontend')}}/images/cancel.png" alt="" />
                    </a>
                    <h4>Login</h4>
                    <p>Don't have an account? Create your account. It's take less then a minutes</p>
                    <form class="s12">
    ...
    <script src="{{asset('ui/frontnd')}/js/main.min.js"></script>
    <script src="{{asset('ui/frontnd')}/js/bootstrap.min.js"></script>
    <script src="{{asset('ui/frontnd')}/js/materialize.min.js"></script>
    <script src="{{asset('ui/frontnd')}/js/custom.js"></script>
</body>
