<x-backend.layouts.admin>
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="page-back"><a href="{{route('subjects.index')}}"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
            </li>
        </ul>
    </div>
    <!--== User Details ==-->
                        ...
                        <form action="{{route('subjects.update', $subjects->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" name="name" value="{{old('name', $subjects->name)}}" class="validate" required>
