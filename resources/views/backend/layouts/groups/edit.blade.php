<x-backend.layouts.admin>
    <div class="sb2-2-2">
        <ul>
            ...
            <li class="page-back"><a href="{{route('groups.index')}}"><i class="fa fa-backward" aria-hidden="true"></i> Back</a>
            </li>
        </ul>
    </div>
    <!--== User Details ==-->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp admin-form">
                    <div class="inn-title">
                        <h4>Update Group Informations</h4>
                        ...
                        <form action="{{route('groups.update', $groups->id)}}" method="post">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" name="name" value="{{old('name', $groups->name)}}" class="validate" required>
