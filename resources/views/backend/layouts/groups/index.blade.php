        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        <a class="btn btn-primary" href="{{route('groups.create')}}">Add New</a>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$group->name}}</td>
                                    <td>
                                        <a href="{{route('groups.edit', $group->id)}}" class="ad-st-view">Update</a>

                                        <form style="display: inline;" action="{{route('groups.destroy', $group->id)}}" method="post">
                                            @csrf
                                            @method('delete')
