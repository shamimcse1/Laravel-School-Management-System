        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp admin-form">
                    <div class="inn-title">
                        <h4>Update Shift Informations</h4>
                    ...
                    <div class="tab-inn">
                        ...
                        @endif
                        <form action="{{route('shifts.update', $shifts->id)}}" method="post">
                            @csrf
                            @method('patch')
                            <div class="row">
                                <div class="input-field col s12">
                                    <input type="text" name="name" value="{{old('name', $shifts->name)}}" class="validate" required>
