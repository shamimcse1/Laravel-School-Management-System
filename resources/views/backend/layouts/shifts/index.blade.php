        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box-inn-sp">
                    <div class="inn-title">
                        <a class="btn btn-primary" href="{{route('shifts.create')}}">Add New</a>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{$shift->name}}</td>
                                    <td>
                                        <a href="{{route('shifts.edit', $shift->id)}}" class="ad-st-view">Update</a>

                                        <form style="display: inline;" action="{{route('shifts.destroy', $shift->id)}}" method="post">
                                            @csrf
                                            @method('delete')
